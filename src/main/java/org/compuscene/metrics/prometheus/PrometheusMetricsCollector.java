...
public class PrometheusMetricsCollector {
    ...
    private boolean isPrometheusKnn;
     ...
     * @param isPrometheusKnn boolean flag for KNN metrics
     */
    ...
    @SuppressWarnings("checkstyle:LineLength")
    private void registerKnnMetrics() {
        // Cluster level
        catalog.registerClusterGauge("knn_circuit_breaker_triggered", "KNN circuit breaker triggered");

        // Node level - Query
        catalog.registerNodeGauge("knn_query_requests", "KNN query requests");
        catalog.registerNodeGauge("knn_query_with_filter_requests", "KNN query with filter requests");
        catalog.registerNodeGauge("knn_graph_query_requests", "KNN graph query requests");
        catalog.registerNodeGauge("knn_graph_query_errors", "KNN graph query errors");
        catalog.registerNodeGauge("knn_script_query_requests", "KNN script query requests");
        catalog.registerNodeGauge("knn_script_query_errors", "KNN script query errors");
        catalog.registerNodeGauge("knn_min_score_query_requests", "KNN min score query requests");
        catalog.registerNodeGauge("knn_min_score_query_with_filter_requests", "KNN min score query with filter requests");
        catalog.registerNodeGauge("knn_max_distance_query_requests", "KNN max distance query requests");
        catalog.registerNodeGauge("knn_max_distance_query_with_filter_requests", "KNN max distance query with filter requests");

        // Node level - Index
        catalog.registerNodeGauge("knn_graph_index_requests", "KNN graph index requests");
        catalog.registerNodeGauge("knn_graph_index_errors", "KNN graph index errors");

        // Node level - Cache
        catalog.registerNodeGauge("knn_cache_hit_count", "KNN cache hit count");
        catalog.registerNodeGauge("knn_cache_miss_count", "KNN cache miss count");
        catalog.registerNodeGauge("knn_cache_eviction_count", "KNN cache eviction count");
        catalog.registerNodeGauge("knn_cache_capacity_reached", "KNN cache capacity reached");
        catalog.registerNodeGauge("knn_load_success_count", "KNN load success count");
        catalog.registerNodeGauge("knn_load_exception_count", "KNN load exception count");
        catalog.registerNodeGauge("knn_total_load_time_seconds", "KNN total load time in seconds");

        // Node level - Memory
        catalog.registerNodeGauge("knn_graph_memory_usage_bytes", "KNN graph memory usage in bytes");
        catalog.registerNodeGauge("knn_graph_memory_usage_percentage", "KNN graph memory usage percentage");
        catalog.registerNodeGauge("knn_training_memory_usage_bytes", "KNN training memory usage in bytes");
        catalog.registerNodeGauge("knn_training_memory_usage_percentage", "KNN training memory usage percentage");

        // Node level - Training
        catalog.registerNodeGauge("knn_training_requests", "KNN training requests");
        catalog.registerNodeGauge("knn_training_errors", "KNN training errors");

        // Node level - Script
        catalog.registerNodeGauge("knn_script_compilations", "KNN script compilations");
        catalog.registerNodeGauge("knn_script_compilation_errors", "KNN script compilation errors");

        // Node level - Engine (with label "engine")
        catalog.registerNodeGauge("knn_engine_initialized", "KNN engine initialized", "engine");

        // Node level - Model
        catalog.registerNodeGauge("knn_indexing_from_model_degraded", "KNN indexing from model degraded");

        // Node level - Graph Stats
        catalog.registerNodeGauge("knn_graph_refresh_total", "KNN graph refresh total");
        catalog.registerNodeGauge("knn_graph_refresh_total_time_seconds", "KNN graph refresh total time in seconds");
        catalog.registerNodeGauge("knn_graph_merge_current", "KNN graph merge current");
        catalog.registerNodeGauge("knn_graph_merge_total", "KNN graph merge total");
        catalog.registerNodeGauge("knn_graph_merge_total_time_seconds", "KNN graph merge total time in seconds");
        catalog.registerNodeGauge("knn_graph_merge_current_docs", "KNN graph merge current docs");
        catalog.registerNodeGauge("knn_graph_merge_total_docs", "KNN graph merge total docs");
        catalog.registerNodeGauge("knn_graph_merge_total_size_bytes", "KNN graph merge total size in bytes");
        catalog.registerNodeGauge("knn_graph_merge_current_size_bytes", "KNN graph merge current size in bytes");

        // Node level - Remote Build Repository Stats
        catalog.registerNodeGauge("knn_remote_build_repo_read_success_count", "KNN remote build repo read success count");
        catalog.registerNodeGauge("knn_remote_build_repo_read_failure_count", "KNN remote build repo read failure count");
        catalog.registerNodeGauge("knn_remote_build_repo_read_time_seconds", "KNN remote build repo read time in seconds");
        catalog.registerNodeGauge("knn_remote_build_repo_write_success_count", "KNN remote build repo write success count");
        catalog.registerNodeGauge("knn_remote_build_repo_write_failure_count", "KNN remote build repo write failure count");
        catalog.registerNodeGauge("knn_remote_build_repo_write_time_seconds", "KNN remote build repo write time in seconds");

        // Node level - Remote Build Stats
        catalog.registerNodeGauge("knn_remote_build_flush_time_seconds", "KNN remote build flush time in seconds");
        catalog.registerNodeGauge("knn_remote_build_merge_time_seconds", "KNN remote build merge time in seconds");
        catalog.registerNodeGauge("knn_remote_build_current_merge_size", "KNN remote build current merge size");
        catalog.registerNodeGauge("knn_remote_build_current_merge_operations", "KNN remote build current merge operations");
        catalog.registerNodeGauge("knn_remote_build_current_flush_operations", "KNN remote build current flush operations");
        catalog.registerNodeGauge("knn_remote_build_current_flush_size", "KNN remote build current flush size");

        // Node level - Remote Build Client Stats
        catalog.registerNodeGauge("knn_remote_build_client_status_request_success_count", "KNN remote build client status request success count");
        catalog.registerNodeGauge("knn_remote_build_client_status_request_failure_count", "KNN remote build client status request failure count");
        catalog.registerNodeGauge("knn_remote_build_client_index_build_success_count", "KNN remote build client index build success count");
        catalog.registerNodeGauge("knn_remote_build_client_index_build_failure_count", "KNN remote build client index build failure count");
        catalog.registerNodeGauge("knn_remote_build_client_build_request_success_count", "KNN remote build client build request success count");
        catalog.registerNodeGauge("knn_remote_build_client_build_request_failure_count", "KNN remote build client build request failure count");
        catalog.registerNodeGauge("knn_remote_build_client_waiting_time_seconds", "KNN remote build client waiting time in seconds");

        // Index cache stats (per index)
        catalog.registerNodeGauge("knn_index_cache_graph_memory_usage_bytes", "KNN index cache graph memory usage in bytes", "index");
        catalog.registerNodeGauge("knn_index_cache_graph_memory_usage_percentage", "KNN index cache graph memory usage percentage", "index");
        catalog.registerNodeGauge("knn_index_cache_graph_count", "KNN index cache graph count", "index");
    }

    @SuppressWarnings("checkstyle:LineLength")
    public void updateKnnMetrics(@Nullable KnnStatsData knnStatsData) {
        if (knnStatsData == null) {
            return;
        }

        // Cluster level
        catalog.setClusterGauge("knn_circuit_breaker_triggered", knnStatsData.isCircuitBreakerTriggered() ? 1 : 0);

        // Node level
        for (Map.Entry<String, KnnStatsData.KnnNodeStats> entry : knnStatsData.getNodes().entrySet()) {
            String nodeId = entry.getKey();
            KnnStatsData.KnnNodeStats node = entry.getValue();

            // KNN API only gives nodeId as the map key, not nodeName.
            // Use nodeId for both fields in the Tuple.
            Tuple<String, String> nodeInfo = new Tuple<>(nodeId, nodeId);

            // Query
            catalog.setNodeGauge(nodeInfo, "knn_query_requests", node.getKnnQueryRequests());
            catalog.setNodeGauge(nodeInfo, "knn_query_with_filter_requests", node.getKnnQueryWithFilterRequests());
            catalog.setNodeGauge(nodeInfo, "knn_graph_query_requests", node.getGraphQueryRequests());
            catalog.setNodeGauge(nodeInfo, "knn_graph_query_errors", node.getGraphQueryErrors());
            catalog.setNodeGauge(nodeInfo, "knn_script_query_requests", node.getScriptQueryRequests());
            catalog.setNodeGauge(nodeInfo, "knn_script_query_errors", node.getScriptQueryErrors());
            catalog.setNodeGauge(nodeInfo, "knn_min_score_query_requests", node.getMinScoreQueryRequests());
            catalog.setNodeGauge(nodeInfo, "knn_min_score_query_with_filter_requests", node.getMinScoreQueryWithFilterRequests());
            catalog.setNodeGauge(nodeInfo, "knn_max_distance_query_requests", node.getMaxDistanceQueryRequests());
            catalog.setNodeGauge(nodeInfo, "knn_max_distance_query_with_filter_requests", node.getMaxDistanceQueryWithFilterRequests());

            // Index
            catalog.setNodeGauge(nodeInfo, "knn_graph_index_requests", node.getGraphIndexRequests());
            catalog.setNodeGauge(nodeInfo, "knn_graph_index_errors", node.getGraphIndexErrors());

            // Cache
            catalog.setNodeGauge(nodeInfo, "knn_cache_hit_count", node.getHitCount());
            catalog.setNodeGauge(nodeInfo, "knn_cache_miss_count", node.getMissCount());
            catalog.setNodeGauge(nodeInfo, "knn_cache_eviction_count", node.getEvictionCount());
            catalog.setNodeGauge(nodeInfo, "knn_cache_capacity_reached", node.isCacheCapacityReached() ? 1 : 0);
            catalog.setNodeGauge(nodeInfo, "knn_load_success_count", node.getLoadSuccessCount());
            catalog.setNodeGauge(nodeInfo, "knn_load_exception_count", node.getLoadExceptionCount());
            catalog.setNodeGauge(nodeInfo, "knn_total_load_time_seconds", node.getTotalLoadTime() / 1_000_000_000.0);

            // Memory
            catalog.setNodeGauge(nodeInfo, "knn_graph_memory_usage_bytes", node.getGraphMemoryUsage() * 1024L);
            catalog.setNodeGauge(nodeInfo, "knn_graph_memory_usage_percentage", node.getGraphMemoryUsagePercentage());
            catalog.setNodeGauge(nodeInfo, "knn_training_memory_usage_bytes", node.getTrainingMemoryUsage() * 1024L);
            catalog.setNodeGauge(nodeInfo, "knn_training_memory_usage_percentage", node.getTrainingMemoryUsagePercentage());

            // Training
            catalog.setNodeGauge(nodeInfo, "knn_training_requests", node.getTrainingRequests());
            catalog.setNodeGauge(nodeInfo, "knn_training_errors", node.getTrainingErrors());

            // Script
            catalog.setNodeGauge(nodeInfo, "knn_script_compilations", node.getScriptCompilations());
            catalog.setNodeGauge(nodeInfo, "knn_script_compilation_errors", node.getScriptCompilationErrors());

            // Engine (with label)
            catalog.setNodeGauge(nodeInfo, "knn_engine_initialized", node.isLuceneInitialized() ? 1 : 0, "lucene");
            catalog.setNodeGauge(nodeInfo, "knn_engine_initialized", node.isFaissInitialized() ? 1 : 0, "faiss");
            catalog.setNodeGauge(nodeInfo, "knn_engine_initialized", node.isNmslibInitialized() ? 1 : 0, "nmslib");

            // Model
            catalog.setNodeGauge(nodeInfo, "knn_indexing_from_model_degraded", node.isIndexingFromModelDegraded() ? 1 : 0);

            // Graph Stats
            KnnStatsData.GraphStats graphStats = node.getGraphStats();
            if (graphStats != null) {
                catalog.setNodeGauge(nodeInfo, "knn_graph_refresh_total", graphStats.getRefresh().getTotal());
                catalog.setNodeGauge(nodeInfo, "knn_graph_refresh_total_time_seconds", graphStats.getRefresh().getTotalTimeInMillis() / 1000.0);
                catalog.setNodeGauge(nodeInfo, "knn_graph_merge_current", graphStats.getMerge().getCurrent());
                catalog.setNodeGauge(nodeInfo, "knn_graph_merge_total", graphStats.getMerge().getTotal());
                catalog.setNodeGauge(nodeInfo, "knn_graph_merge_total_time_seconds", graphStats.getMerge().getTotalTimeInMillis() / 1000.0);
                catalog.setNodeGauge(nodeInfo, "knn_graph_merge_current_docs", graphStats.getMerge().getCurrentDocs());
                catalog.setNodeGauge(nodeInfo, "knn_graph_merge_total_docs", graphStats.getMerge().getTotalDocs());
                catalog.setNodeGauge(nodeInfo, "knn_graph_merge_total_size_bytes", graphStats.getMerge().getTotalSizeInBytes());
                catalog.setNodeGauge(nodeInfo, "knn_graph_merge_current_size_bytes", graphStats.getMerge().getCurrentSizeInBytes());
            }

            // Remote Build Stats
            KnnStatsData.RemoteBuildStats remoteBuildStats = node.getRemoteBuildStats();
            if (remoteBuildStats != null) {
                // Repository
                KnnStatsData.RepositoryStats repoStats = remoteBuildStats.getRepositoryStats();
                catalog.setNodeGauge(nodeInfo, "knn_remote_build_repo_read_success_count", repoStats.getReadSuccessCount());
                catalog.setNodeGauge(nodeInfo, "knn_remote_build_repo_read_failure_count", repoStats.getReadFailureCount());
                catalog.setNodeGauge(nodeInfo, "knn_remote_build_repo_read_time_seconds", repoStats.getSuccessfulReadTimeInMillis() / 1000.0);
                catalog.setNodeGauge(nodeInfo, "knn_remote_build_repo_write_success_count", repoStats.getWriteSuccessCount());
                catalog.setNodeGauge(nodeInfo, "knn_remote_build_repo_write_failure_count", repoStats.getWriteFailureCount());
                catalog.setNodeGauge(nodeInfo, "knn_remote_build_repo_write_time_seconds", repoStats.getSuccessfulWriteTimeInMillis() / 1000.0);
                // Build
                KnnStatsData.BuildStats buildStats = remoteBuildStats.getBuildStats();
                catalog.setNodeGauge(nodeInfo, "knn_remote_build_flush_time_seconds", buildStats.getRemoteIndexBuildFlushTimeInMillis() / 1000.0);
                catalog.setNodeGauge(nodeInfo, "knn_remote_build_merge_time_seconds", buildStats.getRemoteIndexBuildMergeTimeInMillis() / 1000.0);
                catalog.setNodeGauge(nodeInfo, "knn_remote_build_current_merge_size", buildStats.getRemoteIndexBuildCurrentMergeSize());
                catalog.setNodeGauge(nodeInfo, "knn_remote_build_current_merge_operations", buildStats.getRemoteIndexBuildCurrentMergeOperations());
                catalog.setNodeGauge(nodeInfo, "knn_remote_build_current_flush_operations", buildStats.getRemoteIndexBuildCurrentFlushOperations());
                catalog.setNodeGauge(nodeInfo, "knn_remote_build_current_flush_size", buildStats.getRemoteIndexBuildCurrentFlushSize());
                // Client
                KnnStatsData.ClientStats clientStats = remoteBuildStats.getClientStats();
                catalog.setNodeGauge(nodeInfo, "knn_remote_build_client_status_request_success_count", clientStats.getStatusRequestSuccessCount());
                catalog.setNodeGauge(nodeInfo, "knn_remote_build_client_status_request_failure_count", clientStats.getStatusRequestFailureCount());
                catalog.setNodeGauge(nodeInfo, "knn_remote_build_client_index_build_success_count", clientStats.getIndexBuildSuccessCount());
                catalog.setNodeGauge(nodeInfo, "knn_remote_build_client_index_build_failure_count", clientStats.getIndexBuildFailureCount());
                catalog.setNodeGauge(nodeInfo, "knn_remote_build_client_build_request_success_count", clientStats.getBuildRequestSuccessCount());
                catalog.setNodeGauge(nodeInfo, "knn_remote_build_client_build_request_failure_count", clientStats.getBuildRequestFailureCount());
                catalog.setNodeGauge(nodeInfo, "knn_remote_build_client_waiting_time_seconds", clientStats.getWaitingTimeInMs() / 1000.0);
            }

            // Index cache stats (per index)
            Map<String, KnnStatsData.IndexCacheStats> indicesInCache = node.getIndicesInCache();
            if (indicesInCache != null && !indicesInCache.isEmpty()) {
                for (Map.Entry<String, KnnStatsData.IndexCacheStats> indexEntry : indicesInCache.entrySet()) {
                    String indexName = indexEntry.getKey();
                    KnnStatsData.IndexCacheStats indexStats = indexEntry.getValue();
                    catalog.setNodeGauge(nodeInfo, "knn_index_cache_graph_memory_usage_bytes", indexStats.getGraphMemoryUsage() * 1024L, indexName);
                    catalog.setNodeGauge(nodeInfo, "knn_index_cache_graph_memory_usage_percentage", indexStats.getGraphMemoryUsagePercentage(), indexName);
                    catalog.setNodeGauge(nodeInfo, "knn_index_cache_graph_count", indexStats.getGraphCount(), indexName);
                }
            }
        }
    }
