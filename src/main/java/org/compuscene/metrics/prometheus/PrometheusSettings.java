...
public class PrometheusSettings {
    ...
    static String PROMETHEUS_KNN_KEY = "prometheus.knn";
    ...
    /**
     * This setting is used configure weather to expose KNN stats metrics or not. The default value is true.
     * Can be configured in opensearch.yml file or update dynamically under key {@link #PROMETHEUS_KNN_KEY}.
     */
    public static final Setting<Boolean> PROMETHEUS_KNN =
            Setting.boolSetting(PROMETHEUS_KNN_KEY, true,
                    Setting.Property.Dynamic, Setting.Property.NodeScope);
    ...
    public PrometheusSettings(Settings settings, ClusterSettings clusterSettings) {
        ...
        setPrometheusKnn(PROMETHEUS_KNN.get(settings));
        ...
        clusterSettings.addSettingsUpdateConsumer(PROMETHEUS_KNN, this::setPrometheusKnn);
    ...
    private void setPrometheusKnn(boolean flag) {
        this.knn = flag;
    }
    ...
    /**
     * Get value of settings key {@link #PROMETHEUS_KNN_KEY}.
     * @return boolean value of the key
     */
    public boolean getPrometheusKnn() {
        return this.knn;
    }
